...
Contribution guidelines are documented in [CONTRIBUTING.md](CONTRIBUTING.md). Bug reports, reproduction steps, and UX feedback are welcome. Pull Requests are currently limited to focused performance improvements described in the contribution guidelines.
